...
class SpiderTasksLog extends Model
{
     ...
     * @return void
     */
    public static function writeLog(SpiderTask|null $task, string $title = '', array|null $content = [], string $url = '', int $status = self::STATUS_SUCCESS)
    {
        self::create([
     ...
     * 统一记录抛出的异常错误信息
     *
     * @param SpiderTask|null $task
     * @param Exception       $err
     */
    public static function writeErr(SpiderTask|null $task, Exception $err)
    {
        self::writeLog($task, '', [
