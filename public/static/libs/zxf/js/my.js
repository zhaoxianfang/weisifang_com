!function (s) {
    ...
    var my = {
        ...
        regExpFormValidate: function (value, reg_exp_str, ele = "") {
            ...
            var regExp = {
                "email": "^[a-z0-9]+([._\\-]*[a-z0-9])*@([a-z0-9]+[-a-z0-9]*[a-z0-9]+.){1,63}[a-z0-9]+$", // /^[\w\+\-]+(\.[\w\+\-]+)*@[a-z\d\-]+(\.[a-z\d\-]+)*\.([a-z]{2,4})$/i
                "url": "[a-zA-Z0-9][-a-zA-Z0-9]{0,62}(/.[a-zA-Z0-9][-a-zA-Z0-9]{0,62})+/.?",
                "mobile": "^[1][3,4,5,7,8,9][0-9]{9}$", // /^1[3-9]\d{9}$/
                ...
                "time": "^([01]\d|2[0-3])(:[0-5]\d){1,2}$", //00:00到23:59之间的时间
                "zh_cn": "^[\u4e00-\u9fa5]{0,}$", //汉字
