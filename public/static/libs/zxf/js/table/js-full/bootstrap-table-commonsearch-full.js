...
!function ($) {
    ...
    var createFormCommon = function (pColumns, that) {
        ...
        for (var i in pColumns) {
            ...
            if (!vObjCol.checkbox && vObjCol.field !== 'operate' && vObjCol.searchable && vObjCol.operate !== false) {
                var query = my.query(vObjCol.field);
                var operate = my.query(vObjCol.field + "-operate");
    ...
    var createFormBtn = function (that) {
        ...
        htmlBtn.push('<label for="status" class="control-label col-xs-2">&nbsp;</label>');
        htmlBtn.push('<div class="col-sm-10 ">');
