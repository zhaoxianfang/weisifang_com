    ...
    api: {
        ...
        formatter: {
            ...
            toggle: function(value, row, index) {
                ...
                return "<a href='javascript:;' data-toggle='tooltip' title='" + '点击切换' + "' class='btn-change' data-id='" + row.id + "' data-params='" + this.field + "=" + (value == yes ? no : yes) + "'><i class='fa "+ (value == 1 ? 'fa-toggle-on ' : 'fa-toggle-off ') + (value == yes ? 'text-' + color : 'fa-flip-horizontal text-gray') + " fa-2x'></i></a>";
            },
