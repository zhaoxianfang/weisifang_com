...
<table class="table table-bordered table-striped">
  ...
  <tr>
    ...
    <td><code>'fa'</code></td>
    <td>
      <p>Set the base to use a different icon font instead of fas. If changing iconBase, you might also want to change <code>tickIcon</code>, in case the new icon font uses a different naming scheme.</p>
    </td>
  </tr>
  <tr>
    <td>liveSearch</td>
