...
<head>
    ...
    <meta name="keywords" content="威四方,weisifang,wsf,在线文档,markdown,富文本,接口文档,接口测试,权限保护,流程图,甘特图,图表">
    <meta name="description" content="威四方在线文档是一公开绿色、整合了富文本与markdown两种编辑器、自带一套接口请求机制且可测试api、可以设置权限保护、画流程图、甘特图、饼图、时序图等功能的强大文档工具">
...
<div class="message-box">
    <h1>412</h1>
    <p>[威四方]提示您,@if(!empty($message) ) {{ $message }} @else 数据验证失败！ @endif</p>
    <div class="buttons-con">
        <div class="action-link-wrap">
            <a onClick="history.back(-1)" class="link-button link-back-button">返回上一页</a>
            <a href="https://www.weisifang.com" class="link-button">返回首页</a>
        </div>
    </div>
</div>
